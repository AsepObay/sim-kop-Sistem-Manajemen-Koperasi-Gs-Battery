...
@section('title', 'Edit Invoice Voucher')
...
<style>
  ...
  .edit-invoice-page .invoice-voucher-form-control,
  .edit-invoice-page .invoice-voucher-row-input,
  .edit-invoice-page .invoice-voucher-items-table input,
  .edit-invoice-page .invoice-voucher-items-table select {
    box-shadow: none;
  }
  ...
  .edit-invoice-page .invoice-voucher-btn i,
  .edit-invoice-page .invoice-voucher-header i,
  .edit-invoice-page .invoice-voucher-section-head i {
    font-size: 16px;
    line-height: 1;
  }
    ...
    <div class="page-header">
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col-md-12">
                    @include('layouts.dashboard-breadcrumb', ['current' => 'Edit Invoice Voucher'])
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="invoice-voucher-card">
                <div class="invoice-voucher-header">
                    <h5>Edit Tagihan Voucher</h5>
                    <small>Perbarui informasi transaksi voucher.</small>
                </div>
                <div class="invoice-voucher-body">
                    ...
                    <form action="{{ route('invoices.update', $invoice->id) }}?return={{ urlencode($returnUrl) }}" method="POST" id="invoiceVoucherForm">
                        @csrf
                        @method('PUT')
