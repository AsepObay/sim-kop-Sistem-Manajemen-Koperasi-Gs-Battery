...
@section('title', 'Tambah Invoice Voucher')
...
<div class="page-header">
    <div class="page-block">
        <div class="row align-items-center">
            <div class="col-md-12">
                @include('layouts.dashboard-breadcrumb', ['current' => 'Tambah Invoice Voucher'])
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="invoice-voucher-card">
                ...
                <div class="invoice-voucher-body">
                    ...
                    <form action="{{ route('invoices.store-voucher') }}" method="POST" id="invoiceVoucherForm">
                        @csrf

                        <div class="invoice-voucher-grid">
                            <div class="invoice-voucher-field">
                                <label class="invoice-voucher-label">Nomor Invoice</label>
                                <input type="text" class="invoice-voucher-form-control" value="INV/2026/[SEQ]/VOUCHER/[Bulan]" disabled>
                                <small class="invoice-voucher-small">Invoice akan otomatis digenerate dengan format: INV/YYYY/SEQ/VOUCHER/ROMAN_MONTH</small>
                            </div>

                            <div class="invoice-voucher-field">
                                <label class="invoice-voucher-label" for="no_so">Nomor SO <span class="text-danger">*</span></label>
                                <input type="text" name="no_so" id="no_so" class="invoice-voucher-form-control @error('no_so') is-invalid @enderror" value="{{ old('no_so') }}" required>
                                @error('no_so')
                        ...
                        <div class="invoice-voucher-section-head">
                            <h5 class="invoice-voucher-section-title">Item Voucher</h5>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('invoiceVoucherForm').addEventListener('submit', function (e) {
